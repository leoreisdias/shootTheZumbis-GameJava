...
public class Entity {
    ...
    public static BufferedImage ENTITY_GUN_RIGHT = Game.spritesheet.getSprite(144, 16, 16, 16);
    public static BufferedImage ENTITY_GUN_LEFT = Game.spritesheet.getSprite(144, 0, 16, 16);
